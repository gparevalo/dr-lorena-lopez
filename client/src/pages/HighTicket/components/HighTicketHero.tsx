...
export function HighTicketHero({
  ...
  return (
    ...
    >
      ...
      {image && (
        <div
          className="absolute inset-0 bg-cover bg-no-repeat bg-left md:bg-center pointer-events-none bg-center"
          style={{
      ...
      {/* ───────────────── CONTENT ───────────────── */}
      <div className="relative z-10 w-full max-w-2xl px-0 pr-5 sm:px-6 lg:px-10">
        <motion.div
