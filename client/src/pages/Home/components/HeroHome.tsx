...
export default function HeroHome() {
  ...
  return (
    <section className="relative h-[100vh] bg-white overflow-hidden">
      <div className="max-w-[1200px] xl:max-w-[1280px] 2xl:max-w-[1320px] mx-auto px-6 lg:px-12 relative h-full">
        {/* ─── HEADER / TITULO ─── */}
        <motion.div
        ...
        <motion.div
          ...
          className="   md:block absolute top-[43%] md:top-[50%] lg:top-[60%] left-[6%] max-w-md md:max-w-xs text-left z-20"
        >
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.4, duration: 0.8 }}
          className="  hidden lg:block absolute top-[45%] md:top-[50%] lg:top-[60%] left-[6%]  right-[6%] text-right z-20"
        >
        ...
        <div className="absolute  lg:bottom-0 bottom-[0%] md:left-1/2 md:-translate-x-1/2 flex items-end justify-center">
          ...
          >
            <div
              className="
  w-[480px] h-[120px]
  sm:w-[700px] sm:h-[220px]
  md:w-[800px] md:h-[200px]
  lg:w-[900px] lg:h-[160px]
  bg-primary
  rounded-t-[120px]
